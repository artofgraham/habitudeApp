...
class TrackersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tracker" do
    assert_difference("Tracker.count") do
      post trackers_url, params: { tracker: { days: @tracker.days, habitdate: @tracker.habitdate, score: @tracker.score, title: @tracker.title, total: @tracker.total, user_id: @tracker.user_id } }
    end
  ...
  test "should update tracker" do
    patch tracker_url(@tracker), params: { tracker: { days: @tracker.days, habitdate: @tracker.habitdate, score: @tracker.score, title: @tracker.title, total: @tracker.total, user_id: @tracker.user_id } }
